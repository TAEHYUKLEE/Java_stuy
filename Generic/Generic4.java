...
class Person<T extends Info>{
	...
	//참고로 이 Generic package안에 Person만 3개 있다.
	//Person<T, S>, Person() 등 근데 빨간줄 안뜨는 이유 -> Overloading때문일 것.
	public T info;
	Person(T info){
		this.info = info;
...
public class Generic4 {
	...
	public static void main(String[] args) {
		Person<EmployeeInfo2> p1 = new Person<EmployeeInfo2>(new EmployeeInfo2(1));
