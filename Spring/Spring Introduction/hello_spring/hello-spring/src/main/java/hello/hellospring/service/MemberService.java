...
@Service // Spring이 올라올때 어 Service네 하고 스프링 컨테이너에 MemberService를 넣어준다.
public class MemberService {
    ...
    //외부에서 넣어주게 해준다. MemberService를 Dependency Injection (DI)
    @Autowired //구현체인 MemoryMemberRepository를 MemberService에 넣어준다.
